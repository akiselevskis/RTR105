...
#            "derivative.dat" every ::1 using 1:2 with lines title "cos(x/2)^2", \
#            "derivative.dat" every ::1 using 1:3 with lines title "(cos(x/2)^2)'", \
#            "derivative.dat" every ::1 using 1:4 with lines title "(cos(x/2)^2)''"

plot "derivative.dat" every ::1 using 1:2 with lines title "cos(x/2)^2", \
     "derivative.dat" every ::1 using 1:3 with lines title "(cos(x/2)^2)'", \
     "derivative.dat" every ::1 using 1:5 with lines title "(cos(x/2)^2)''"
